...
let __tla = (async () => {
  ...
  const O = "" + new URL("../assets/kernel_bg.X_9bu_jF.wasm", import.meta.url).href, B = async (e = {}, t) => {
    let n;
  ...
  }, O), X = f.memory, K = f.eval_input, P = f.__wbindgen_externrefs, V = f.__wbindgen_malloc, Y = f.__wbindgen_realloc, $ = f.__wbindgen_free, p = f.__wbindgen_start, q = Object.freeze(Object.defineProperty({
    __proto__: null,
